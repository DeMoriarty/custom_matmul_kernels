...
2. No need for loop  
3. Possibily faster than argmin (less memory ops).  

The K-Means implementation is [here](https://github.com/DeMoriarty/TorchPQ/tree/main/torchpq/kmeans), 
And [this](https://github.com/DeMoriarty/TorchPQ/blob/main/torchpq/kmeans/kernels/MaxSimKernel.cu) is the fused kernel. Maybe I will put them into this repo later.  
...
By modifying our matmul kernel, we can **multiply the hidden vector of each token in the minibatch to a unique subset of output embeddings**
